#ifndef ELASTICBENDINGFORCEPLATE_H
#define ELASTICBENDINGFORCEPLATE_H

#include "eigenIncludes.h"
#include "elasticPlate.h"
#include "timeStepperPlate.h"

class elasticBendingForcePlate
{
public:
	elasticBendingForcePlate(elasticPlate &m_plate, timeStepperPlate &m_stepper);
	~elasticBendingForcePlate();
