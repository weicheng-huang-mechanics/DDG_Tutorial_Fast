...
elasticBendingForcePlate::elasticBendingForcePlate(elasticPlate &m_plate, timeStepperPlate &m_stepper)
{
	plate = &m_plate;
    stepper = &m_stepper;
...
elasticBendingForcePlate::~elasticBendingForcePlate()
{
	;
}

void elasticBendingForcePlate::computeFb()
{
...
void elasticBendingForcePlate::computeJb()
{
    for (int i = 0; i < plate->bendingNum; i++)
    {
        arrayNum = plate->v_bendingElement[i].arrayNum;
...
void elasticBendingForcePlate::setFirstJacobian()
{
    for (int i = 0; i < plate->bendingNum; i++)
    {
        arrayNum = plate->v_bendingElement[i].arrayNum;
...
Matrix3d elasticBendingForcePlate::skemMatrix(Vector3d a)
{
    Matrix3d b;
...
Matrix3d elasticBendingForcePlate::hessionMatrix_1(Vector3d a)
{
    double normA = a.norm();
...
Matrix3d elasticBendingForcePlate::hessionMatrix_2(Vector3d a)
{
    double normA = a.norm();
...
Matrix3d elasticBendingForcePlate::hessionMatrix_3(Vector3d a)
{
    double normA = a.norm();
