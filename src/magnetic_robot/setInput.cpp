...
setInput::setInput()
{
  ...
  AddOption("YoungRod", "YoungRod", YoungRod);
  AddOption("YoungPlate", "YoungPlate", YoungPlate);
  AddOption("densityRod", "densityRod", densityRod);
  AddOption("densityPlate", "densityPlate", densityPlate);
  ...
  AddOption("length", "length", length);
  AddOption("width", "width", width);
  AddOption("deltaLength", "deltaLength", deltaLength);

  AddOption("xNum", "xNum", xNum);
  AddOption("yNum", "yNum", yNum);
  AddOption("xLength", "xLength", xLength);
  AddOption("yLength", "yLength", yLength);
  ...
  AddOption("cutIndex", "cutIndex", cutIndex);
}
